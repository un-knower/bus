...
public class Util {
    ...
    static LinkedBlockingDeque<String> Contents = new LinkedBlockingDeque<>(150);//内容阻塞队列，最多可存储150个对象
    private static ExecutorService ReadThreadPool = Executors.newFixedThreadPool(5);//读文件到线程池，最多5个线程
